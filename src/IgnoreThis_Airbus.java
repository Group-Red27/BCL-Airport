...
public class IgnoreThis_Airbus extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IgnoreThis_Airbus frame = new IgnoreThis_Airbus();
	...
	public IgnoreThis_Airbus() {
		...
		seatNumber[0].addActionListener(listener);
		...
		seatNumber[1].addActionListener(listener);
		...
		seatNumber[2].addActionListener(listener);
		...
		seatNumber[3].addActionListener(listener);
		...
		seatNumber[4].addActionListener(listener);
